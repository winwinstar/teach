...
newRow.innerHTML = '<td align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox2" value="checkbox"></td>'+ 
      '<td bgcolor="#FFFFFF">'+lastRow.rowIndex+'</td>'+  
...
//提取表格的值,JSON格式  
function GetTableData(table,url){
var tableData = new Array();
for(var i=1; i<table.rows.length;i++){  
   tableData.push(GetRowData(tabProduct.rows[i]));  
}
    SubmitArticle(tableData,url);
return tableData;
}  
//提取指定行的数据，JSON格式  
